...
for (i in unique(df_all$Year)) {
  ...
  star_summary[["five_star"]][star_summary$Var1==i] <- star_table[["Freq"]][star_table$Var1==5]
  star_summary[["four_star"]][star_summary$Var1==i] <- star_table[["Freq"]][star_table$Var1==4]
  star_summary[["three_star"]][star_summary$Var1==i] <- star_table[["Freq"]][star_table$Var1==3]
  star_summary[["two_star"]][star_summary$Var1==i] <- star_table[["Freq"]][star_table$Var1==2]
}
